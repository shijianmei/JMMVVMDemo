...
@implementation JMEvaluateModel
...
- (void)calculateCellHeightWithDic:(NSDictionary *)dic
{
    ...
    CGSize commContentSzie = [AppHelper sizeWithFont:[UIFont systemFontOfSize:14] Str:commContent withMaxWidth:kScreenWidth-20];
    ...
    if (replyContent.length > 5) {
        ...
        CGSize replyContentSzie = [AppHelper sizeWithFont:[UIFont systemFontOfSize:14] Str:replyContent withMaxWidth:kScreenWidth-40];
...
- (void)calculateCellHeight
{
    ...
    CGSize commContentSzie = [AppHelper sizeWithFont:[UIFont systemFontOfSize:14] Str:commContent withMaxWidth:kScreenWidth-54];
    ...
    if (replyContent.length > 5) {
            //有回复
        height = height + 20; //+20是上下之间的间隔。
        CGSize replyContentSzie = [AppHelper sizeWithFont:[UIFont systemFontOfSize:14] Str:replyContent withMaxWidth:kScreenWidth-74];
        height = height + replyContentSzie.height + 20 + 20;
    }else{
            //无回复
        height = height + 20;
...
- (void)calculateTakeawayEvaluateCellHeight
{
    CGFloat  height = 42;
        //评论内容
    NSString *commContent = self.commContent;
    CGSize commContentSzie = [AppHelper sizeWithFont:[UIFont systemFontOfSize:12] Str:commContent withMaxWidth:kScreenWidth-60];
    ...
    if (replyContent.length > 5) {
        ...
        CGSize replyContentSzie = [AppHelper sizeWithFont:[UIFont systemFontOfSize:12] Str:replyContent withMaxWidth:kScreenWidth-80];
