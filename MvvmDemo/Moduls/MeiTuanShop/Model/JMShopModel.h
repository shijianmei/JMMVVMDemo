...
/** 优惠券*/
@property (nonatomic ,strong) NSArray <JMCouponListModel *> *couponList;
/** 活动*/
@property (nonatomic ,strong) NSArray <JMCouponListModel *> *activityList;
...
@interface JMCouponListModel : NSObject
#pragma mark --- 优惠券
/***/
