...
@interface JMShopMerchantView()<UITableViewDelegate,UITableViewDataSource,SDPhotoBrowserDelegate>
{
    UIScrollView *_scrollView ;
}
@end

@implementation JMShopMerchantView
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section == 0) {
        ...
        CGSize size = [AppHelper sizeWithFont:kFont(12) Str:_shopModel.shopIntroduce withMaxWidth:self.width];
        ...
        if (indexPath.row == 1) {
            ...
            CGSize size = [AppHelper sizeWithFont:kFont(12) Str:text withMaxWidth:self.width - 43];
    ...
    if (!cell) {
        ...
        if (indexPath.section == 0) {
            ...
            }else if (indexPath.row == 1)
            {
                ...
                CGSize size = [AppHelper sizeWithFont:kFont(12) Str:text withMaxWidth:textLab.mj_w];
