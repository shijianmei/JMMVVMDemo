...
@implementation JMReserveEvluateCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        CGSize size = [AppHelper sizeWithFont:[UIFont systemFontOfSize:14] Str:str withMaxWidth:kScreenWidth-54];
        ...
        _topImgView.frame = CGRectMake(44+30, _replyView.y-8, 15, 8);
...
- (void)setModel:(JMEvaluateModel *)model
{
    ...
    if (replyContent.length > 5) {
        ...
        _topImgView.mj_y = _replyView.y-8;
        
        NSMutableAttributedString *replyStr = [AppHelper returnStringColor:replyContent rang:NSMakeRange(5, replyContent.length-5) color:kColor_ReplyColor];
